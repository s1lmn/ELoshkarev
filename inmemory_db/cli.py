"""Console interface for the in-memory database."""
...
class ConsoleInterface:
    """Interactive console UI for working with the database."""
    ...
    def _print_welcome(self) -> None:
        self.io.output("In-memory база данных")
        self.io.output(
    ...
    def _print_menu(self) -> None:
        ...
        self.io.output("7. Показать список таблиц")
